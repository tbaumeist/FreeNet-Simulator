...
public final class Arguments {
	...
	/**
	 * Graph input stream DOT format.
	 */
	public final DataInputStream graphInputText;
	/**
	...
	private static final Option OPT_GRAPH_LOAD_DOT = new Option("gl",
	...
	private Arguments(final boolean lattice, final boolean fastGeneration,
			...
			final DataInputStream graphInputText,
		...
		this.graphInputText = graphInputText;
	...
	public static Arguments parse(final String[] args) throws Exception {
		...
		final DataInputStream degreeInput, linkInput, graphInput, graphInputText;
		try {
			...
			graphInputText = readableFile(OPT_GRAPH_LOAD_DOT.getLongOpt(), cmd);
		...
		return new Arguments(lattice, fastGeneration, cmd.hasOption(OPT_PROBE
				...
				graphInputText, degreeOutput, linkOutput, graphOutput,
				graphOutputText, cmd.getOptionValue(OPT_PROBE_OUTPUT
						.getLongOpt()), routingSimOutput, foldingPolicy,
				routingPolicy, nLookAhead, logLevel, pause, oldPathFolding, cmd);
	}
}
